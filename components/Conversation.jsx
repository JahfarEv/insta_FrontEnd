...
const Conversation = ({conversation,lastidx}) => {
  ...
  return (
    <>
    <div className={`flex gsp-2 items-center hover:bg-sky-500 rounded p-2 py-1 cursor-pointer ${isSelected ? "bg-sky-500" :""}`} onClick={()=> setSelectedConversation(conversation)}>
